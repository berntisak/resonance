...
namespace LaptopOrchestra.Kinect.ViewModel
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            CurrentWindow.SwitchIcon = "/Assets/switch-dancers.png";
        ...
        private void UI_Thread(object sender, MultiSourceFrameArrivedEventArgs e)
        {
            ...
            else
            {
                using (bodyFrame)
                {
                    ...
                    int bodyNum = 1; // Start at 1 to match MAX side
                    ...
                    foreach (var body in _bodies)
                    {
                        ...
                        mainWin.XAMLCanvas.DrawSkeleton(body, alignedJointPoints, bodyNum);
                        bodyNum++;
        ...
        private RelayCommand _switchDancerCommand;
        public RelayCommand SwitchDancerCommand
        {
            get
            {
                if (_switchDancerCommand == null)
                {
                    _switchDancerCommand = new RelayCommand(param => this.SwitchDancerCommandLogic());
                }
                return _switchDancerCommand;
            }
        }
        private void SwitchDancerCommandLogic()
        {
            // swap dancer colors
            BitmapHelper.DancerSwitchedColorSwap();
            DataSubscriber.DancerSwitched = !DataSubscriber.DancerSwitched;
            Debug.WriteLine(DataSubscriber.DancerSwitched);
        }
        ...
        {
            Process.Start("https://ubcsubclass2016.wordpress.com/");
        }
        ...
        {
            const string message = "KiCASS was created and developed by students from the University of British Columbia, Canada. Version 1.0 was released March 22, 2016."
                + "\n\nCapstone Teams:"
                + "\n(2015-16) Isaac Cheng, Russil Glover, Kelsey Hawley, Kevin Hui, and Michael Sargent"
                + "\n(2016-17) Dominique Low, Theresa Mammarella, Geoff Shaw, Emmett Tan, and Justin Wang"
                + "\n\nCurrent Version: " + Constants.CurrentVersion
                + "\n\nVisit SUBCLASS at https://ubcsubclass2016.wordpress.com/";
